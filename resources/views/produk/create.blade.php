            ...
            <div class="col-md-12">
                <div class="panel panel-default" style="border:1px solid lightgray;padding :20px;">
                    ...
                    <div class="panel-body" style="margin-top:15px">
                        <form action="{{ route('produk.store') }}" method="POST" role="form" class="form-horizontal">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <div class=" col-md-6">
                                    <input id="beli" type="number" class="form-control" name="beli" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class=" col-md-6">
                                    <input id="jual" type="number" class="form-control" name="jual" autofocus>
                                </div>
                            </div>
